                    ...
                    echo '<news:news>';
                        if(isset($url['news']['publication'])){
                            echo '<news:publication>';
                                echo (isset($url['news']['publication']['name']) ? '<news:name>'.$url['news']['publication']['name'].'</news:name>' : '');
                                echo (isset($url['news']['publication']['language']) ? '<news:language>'.$url['news']['publication']['language'].'</news:language>' : '');
                            echo '</news:publication>';
                        }
                        ...
                        echo (isset($url['news']['publication_date']) ? '<news:publication_date>'.$url['news']['publication_date'].'</news:publication_date>' : '');
                        echo (isset($url['news']['title']) ? '<news:title>'.$url['news']['title'].'</news:title>' : '');
